...
# Save to Parquet
try:
    tb_data_preprocess.to_parquet("data/processed/tb_data.parquet", index=False)
...
try:
    ...
    rf_data_preprocess.to_parquet("data/processed/rf_data.parquet", index=False)
